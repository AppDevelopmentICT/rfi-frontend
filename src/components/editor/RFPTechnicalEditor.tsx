...
export function RFPTechnicalEditor({ rfpId }: RFPTechnicalEditorProps) {
    ...
    try {
      ...
      if (currentContent) {
        ...
        stream.generate(locked.product, {
          projectName: locked.project_name || undefined,
          projectDescription: locked.project_description || undefined,
  ...
  return (
    <div className="grid h-full gap-4 lg:grid-cols-[minmax(0,1fr)_360px] xl:grid-cols-[minmax(0,1fr)_400px]">
      ...
      <Card className="flex h-full min-h-[60vh] flex-col border-border/70 shadow-sm">
        <CardHeader className="flex-row items-center justify-between space-y-0 border-b py-3">
          <CardTitle className="flex items-center gap-2 text-base">
